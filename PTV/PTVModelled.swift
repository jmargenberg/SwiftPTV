...
class PTVModelled: PTV {
    ...
    public func getRouteTypes(failure: @escaping PTV.FailureHandler, completion: @escaping (_ routeTypes: [RouteType]) -> ()) {
    ...
    private func getRoutes(params: [String: String], failure: @escaping PTV.FailureHandler, completion: @escaping (_ routes: [Route]) -> ()) {
    ...
    public func getRoutes(failure: @escaping PTV.FailureHandler, completion: @escaping (_ routes: [Route]) -> ()) {
        self.call(apiName: "routes", searchString: "", params: nil, decodeTo: RoutesResponse.self, failure: failure) { (routesResponse) in
            completion(routesResponse.routes)
        }
    }
    
    public func getRoutes(forRouteTypeID routeTypeID: Int, failure: @escaping PTV.FailureHandler, completion: @escaping (_ routes: [Route]) -> ()) {
        self.getRoutes(failure: failure) { (routes) in
            completion(routes.filter({ $0.route_type == routeTypeID }))
        }
    }
    
    public func getRoutes(forRouteTypeIDs routeTypeIDs: [Int], failure: @escaping PTV.FailureHandler, completion: @escaping (_ routes: [Route]) -> ()) {
    ...
    public func getStops(nearLocation location: CLLocationCoordinate2D, forRouteTypes routeTypes: [Int] = [PTVCached.TRAIN_ROUTE_TYPE], maxResults: Int = 1000, maxDistance: Int = 5000, failure: @escaping PTV.FailureHandler, completion: @escaping (([StopGeosearch]) -> ())) {
    ...
    public func getStops(onRoute routeId: Int, forRouteType routeTypeId: Int = PTVCached.TRAIN_ROUTE_TYPE, failure: @escaping PTV.FailureHandler, completion: @escaping (([StopOnRoute]) -> ())) {
    ...
    public func getStopDetails(forStop stopId: Int, forRouteType routeTypeId: Int = PTVCached.TRAIN_ROUTE_TYPE, failure: @escaping PTV.FailureHandler, completion: @escaping ((StopDetails) -> ())) {
    ...
    public func getDeparture(forStop stopId: Int, withRouteType routeTypeId: Int, failure: @escaping PTV.FailureHandler, completion: @escaping (([Departure]) -> ())) {
    ...
    public func getStoppingPattern(forRun runId: Int, withRouteType routeTypeId: Int, failure: @escaping PTV.FailureHandler, completion: @escaping (StoppingPattern) -> ()) {
